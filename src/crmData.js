...
export const seedCases = [
  {
    ...
    coreProducts: ['AI 内容营销', '企业 GEO', 'AI 搜索排名优化', '品牌大模型推荐', '杭州 AI 营销'], highlights: ['建立统一品牌实体页', '覆盖 5 个 AI 平台样本', '问题词与地域词同步监测'], tone: 'violet', evidenceExternalId: 'doubao-38436432341358082', evidenceKind: 'platform',
  ...
  },
  {
    ...
    coreProducts: ['AI 学习课程', '企业培训', '内容运营课', 'AI 工具实战', '教育咨询'], highlights: ['课程知识结构化', '专家观点可信化', '平台问答持续回查'], tone: 'blue', evidenceExternalId: 'case-demo-chengming-20260811', evidenceKind: 'internal',
    ...
    questions: [{ keyword: '企业 AI 培训课程怎么选', platform: '案例演示', device: 'PC', target: '澄明课堂', saved: true }, { keyword: 'AI 工具实战课程推荐', platform: 'DeepSeek', device: '移动端', target: '品牌名称', saved: false }, { keyword: '内容运营培训方法', platform: '千问', device: 'PC', target: '未形成引用', saved: false }],
  },
  {
    ...
    coreProducts: ['品牌咨询', '企业战略', '增长顾问', '品牌定位', '深圳咨询公司'], highlights: ['行业比较词建模', '客户案例结构化', '决策路径内容补齐'], tone: 'cyan', evidenceExternalId: 'case-demo-xianghai-20260811', evidenceKind: 'internal',
    ...
    questions: [{ keyword: '深圳品牌咨询公司怎么选', platform: '案例演示', device: '移动端', target: '向海咨询', saved: true }, { keyword: '企业战略顾问怎么选', platform: '豆包', device: '移动端', target: '品牌名称', saved: false }, { keyword: '品牌定位服务费用', platform: 'Kimi', device: 'PC', target: '未形成引用', saved: false }],
  },
  {
